...
export class PigmentGallery extends PIXI.Sprite {
  ...
  start() {
    ...
    const BG = ResourceManager.Handle.getViewerResource("popup_pigment_bg.png")
      .texture;
    this.texture = BG;

    const close = new Button(
      ResourceManager.Handle.getViewerResource(
        "pigment_closebtn_normal.png"
      ).texture,
      ResourceManager.Handle.getViewerResource(
        "pigment_closebtn_down.png"
      ).texture,
      ResourceManager.Handle.getViewerResource(
        "pigment_closebtn_over.png"
      ).texture
    );
    ...
    const left = new Button(
      ResourceManager.Handle.getViewerResource(
        "pigment_arrow_l_normal.png"
      ).texture,
      ResourceManager.Handle.getViewerResource(
        "pigment_arrow_l_down.png"
      ).texture,
      ResourceManager.Handle.getViewerResource(
        "pigment_arrow_l_over.png"
      ).texture
    );
    ...
    const right = new Button(
      ResourceManager.Handle.getViewerResource(
        "pigment_arrow_r_normal.png"
      ).texture,
      ResourceManager.Handle.getViewerResource(
        "pigment_arrow_r_down.png"
      ).texture,
      ResourceManager.Handle.getViewerResource(
        "pigment_arrow_r_over.png"
      ).texture
    );
    right.position.set(
  ...
  changeList() {
    ...
    for (let i = 1; i <= 6; i++) {
      ...
      if (PigmentModule.setRecieved.length !== 0) {
        respo.texture = ResourceManager.Handle.getViewerResource(
          PigmentModule.setRecieved.arguments
        ).texture;
      } else {
        respo.texture = ResourceManager.Handle.getViewerResource(
          `no_frame.png`
